        ...
        <Col md={3}>
          ...
          <div>
            ...
            <ul>
              ...
              {prices.map((p) => (
                <li key={p.value}>
                  <Link to={getFilterUrl(search, { price: p.value })} className={p.value === price ? "text-bold" : ""}>
                    {p.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul>
              {ratings.map((r) => (
                <li key={r.name}>
                  <Link to={getFilterUrl(search, { rating: r.rating })} className={`${r.rating}` === `${rating}` ? "text-bold" : ""}>
            ...
            <>
              ...
              <div>
                {[...Array(pages).keys()].map((x) => (
                  ...
                  >
                    <Button className={Number(page) === x + 1 ? "current-page-number" : ""} variant="light">
                      {x + 1}
                    </Button>
                  </LinkContainer>
                ))}
